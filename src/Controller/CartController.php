...
/**
     * @Route("/panier/add_list/{id}", name="cart_add_list")
     */
//    public function add($id, Request $request)
//    public function add($id, SessionInterface $session, ProductRepository $productRepository)
public function add_list($id,CartService $cartService)
{
    // J'utilise le CartService qui contient les methodes necessaires pour ajouter un produits
    $cartService->add_list($id);
    // Ci-dessous l'ancienne méthode avant la création du cartServie !!!!!!!!!!!!!!
...
////        ]);
    ...
    /**
     * @Route("/panier/listToCart/{id}", name="checklist_add_cart")
     */
    public function listToCart($id, CartService $cartService)
    {
        $cartService->listToCart($id);
    ...
    /**
     * @Route("/panier/removeList/{id}", name="checklist_remove")
     */
    public function removeList($id, CartService $cartService)
    {
        $cartService->removeList($id);
