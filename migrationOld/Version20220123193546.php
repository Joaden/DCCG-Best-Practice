 ...
 */
final class Version20220123193546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE full_name full_name VARCHAR(100) NOT NULL, CHANGE username username VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE saying saying VARCHAR(100) DEFAULT NULL');
    }
